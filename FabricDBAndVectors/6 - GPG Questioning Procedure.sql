...
exec @retval = dbo.get_embedding 'textembedding', @search_text,@search_vector output;
...
declare @url nvarchar(max)='https://aiopentraining.openai.azure.com/openai/deployments/' + @deployedModelName + '/chat/completions?api-version=2024-08-01-preview' -- Completions API
